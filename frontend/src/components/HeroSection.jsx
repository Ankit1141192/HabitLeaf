    ...
    <div className="relative w-full h-[600px] rounded-lg shadow-md overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col md:flex-row items-center justify-between px-10 md:px-20">
        ...
        <div className="text-white max-w-xl text-center md:text-left">
          <span className="inline-block bg-green-600/90 px-3 py-1 rounded-full text-sm font-medium mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button className="border border-white/70 text-white font-semibold py-3 px-6 rounded-full hover:bg-white hover:text-green-700 transition duration-300">
              Watch Demo
            </button>
          </div>
        </div>
